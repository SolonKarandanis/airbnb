...
public class FileUtil {
     ...
     *            Zip file.
     * @param destDir
     *            Absolute path to unpacked folder
     * @throws AirbnbException
     */
    public static List<File> unZip(File f, File destDir) throws AirbnbException {
        ...
        try {
            ...
            throw new AirbnbException("error.unpacking.zip", ex);
        } finally {
     ...
     *
     * @param file
     *            Absolute path to unpack folder
    ...
    public static HashSet<String> getFileNamesFromZip(byte[] bytesZip) throws AirbnbException {
        ZipEntry entry;
        ...
        try {
            ...
            throw new AirbnbException("error.unpacking.zip", e);
        }
        return retSet;
    }
    
    public static Map<String, ZipEntry> getZipEntriesFromZip(byte[] bytesZip) throws AirbnbException {
        ZipEntry entry;
    ...
    public static File zip(String zipName, List<File> filesToZip, String destinationDir) throws AirbnbException {
        return zip(zipName, filesToZip, new File(destinationDir));
    }
     ...
     */
    public static File zip(String zipName, List<File> filesToZip, File destinationDir) throws AirbnbException {
        ...
        try {
            ...
            log.error("IO error in file zip {}", e);
            throw new AirbnbException("error.zipping.files", e);
        } finally {
