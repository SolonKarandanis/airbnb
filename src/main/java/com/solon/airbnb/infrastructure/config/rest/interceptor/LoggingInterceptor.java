package com.solon.airbnb.infrastructure.config.rest.interceptor;
...
public class LoggingInterceptor implements ClientHttpRequestInterceptor {
    ...
    @Override
    public ClientHttpResponse intercept(HttpRequest request, byte[] reqBody, ClientHttpRequestExecution execution)
            throws IOException {
