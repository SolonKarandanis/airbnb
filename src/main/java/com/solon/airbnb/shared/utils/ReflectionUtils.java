...
public abstract class ReflectionUtils {
     ...
     * Attempt to find a {@link Field field} on the supplied {@link Class} with
     * the supplied
     * <code>name</code> and/or {@link Class type}. Searches all superclasses up
     * to {@link Object}.
     *
     * @param clazz the class to introspect
     ...
     * field has a primitive type. <p>Thrown exceptions are handled via a call
     * to {@link #handleReflectionException(Exception)}.
     *
     ...
     * wrapped if the underlying field has a primitive type. <p>Thrown
     * exceptions are handled via a call to
     ...
     * @param clazz the class to introspect
     * @param name the name of the method
     * @param paramTypes the parameter types of the method (may
     * be <code>null</code> to indicate any signature)
     * @return the Method object, or <code>null</code> if none found
     */
     ...
     * with no arguments. The target object can be
     * <code>null</code> when invoking a static {@link Method}. <p>Thrown
    ...
    /**
     * Invoke the specified {@link Method} against the supplied target object
     * with the supplied arguments. The target object can be
     * <code>null</code> when invoking a static {@link Method}. <p>Thrown
     * exceptions are handled via a call to {@link #handleReflectionException}.
     *
     * @param method the method to invoke
     ...
     * target method. <p>Rethrows the underlying exception cast to an
     * {@link RuntimeException} or {@link Error} if appropriate; otherwise,
     ...
     * only be called if no checked exception is expected to be thrown by the
     * target method. <p>Rethrows the underlying exception cast to an
     * {@link Exception} or {@link Error} if appropriate; otherwise, throws an
    ...
    public static boolean isObjectMethod(Method method) {
        try {
        	var unused =Object.class.getDeclaredMethod(method.getName(), method.getParameterTypes());
            return true;
     ...
     * necessary. The
     * <code>setAccessible(true)</code> method is only called when actually
     ...
     * class and superclasses. <p>The same named method occurring on subclass
     * and superclass will appear twice, unless excluded by a
     * {@link MethodFilter}.
     *
    ...
    /**
     * Perform the given callback operation on all matching methods of the given
     * class and superclasses (or given interface and super-interfaces). <p>The
     * same named method occurring on subclass and superclass will appear twice,
