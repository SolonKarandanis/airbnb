...
public abstract class Assert {
     ...
     * <code>false</code>. <pre class="code">Assert.isTrue(i &gt; 0, "The value
     * must be greater than zero");</pre>
     *
     ...
     * <code>null</code> . <pre class="code">Assert.isNull(value, "The value
     * must be null");</pre>
     *
    ...
    /**
     * Assert that an object is
     * <code>null</code> . <pre class="code">Assert.isNull(value);</pre>
     *
     * @param object the object to check
     * @throws IllegalArgumentException if the object is not <code>null</code>
     */
     ...
     * <code>null</code> . <pre class="code">Assert.notNull(clazz, "The class
     * must not be null");</pre>
     *
     * @param object the object to check
     * @param message the exception message to use if the assertion fails
    ...
    /**
     * Assert that an object is not
     * <code>null</code> . <pre class="code">Assert.notNull(clazz);</pre>
     *
     * @param object the object to check
     * @throws IllegalArgumentException if the object is <code>null</code>
     */
     ...
     * class="code">Assert.doesNotContain(name, "rod", "Name must not contain
     * 'rod'");</pre>
     *
     ...
     * class="code">Assert.notEmpty(array, "The array must have
     * elements");</pre>
     *
     ...
     * array is empty! <pre class="code">Assert.noNullElements(array, "The array
     * must have non-null elements");</pre>
     *
     * @param array the array to check
     * @param message the exception message to use if the assertion fails
     * @throws IllegalArgumentException if the object array contains
     ...
     * <code>null</code> and must have at least one element. <pre
     * class="code">Assert.notEmpty(collection, "Collection must have
     * elements");</pre>
     *
     ...
     * <code>null</code> and must have at least one entry. <pre
    ...
    /**
     * Assert that
     * <code>superType.isAssignableFrom(subType)</code> is
    ...
    /**
     * Assert a boolean expression, throwing
     * <code>IllegalStateException</code> if the test result is
     * <code>false</code>. Call isTrue if you wish to throw
     * IllegalArgumentException on an assertion failure. <pre
     * class="code">Assert.state(id == null, "The id property must not already
     * be initialized");</pre>
     *
     * @param expression a boolean expression
     * @param message the exception message to use if the assertion fails
     ...
     * the test result is
     * <code>false</code>. <p>Call {@link #isTrue(boolean)} if you wish to throw
     * {@link IllegalArgumentException} on an assertion failure. <pre
     * class="code">Assert.state(id == null);</pre>
     *
     * @param expression a boolean expression
     * @throws IllegalStateException if the supplied expression
     * is <code>false</code>
     */
