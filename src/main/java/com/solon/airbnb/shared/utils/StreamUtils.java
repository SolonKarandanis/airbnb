...
public abstract class StreamUtils {
	...
	private static final String NO_OUTPUT_STREAM_SPECIFIED= "No OutputStream specified";
	private static final String NO_INPUT_STREAM_SPECIFIED="No InputStream specified";
	...
	public static void copy(byte[] in, OutputStream out) throws IOException {
		...
		Assert.notNull(out, NO_OUTPUT_STREAM_SPECIFIED);
	...
	public static int copy(InputStream in, OutputStream out) throws IOException {
		Assert.notNull(in, NO_INPUT_STREAM_SPECIFIED);
		Assert.notNull(out, NO_OUTPUT_STREAM_SPECIFIED);
